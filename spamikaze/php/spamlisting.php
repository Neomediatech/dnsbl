...
{
    if (preg_match( "/^([0-9]{1,3}(\.[0-9]{1,3}){3})$/", $_REQUEST['ipfirst']))
        $fip = $_REQUEST['ipfirst'];

    if (preg_match( "/^([0-9]{1,3}(\.[0-9]{1,3}){3})$/", $_REQUEST['ipsecond']))
        $sip = $_REQUEST['ipsecond'];


    if (preg_match( "/^([0-9]{1,3}(\.[0-9]{1,3}){2})$/", $_REQUEST['ipfirst']))
    {       
        $fip = $_REQUEST['ipfirst'] . ".0";
        $sip = $_REQUEST['ipfirst'] . ".255";
    }

    if (preg_match( "/^([0-9]{1,3}(\.[0-9]{1,3}){1})$/", $_REQUEST['ipfirst']))
    {
        $fip = $_REQUEST['ipfirst'] . ".0.0";
        $sip = $_REQUEST['ipfirst'] . ".255.255";
    }

    if (preg_match( "/^([0-9]{1,3}(\.[0-9]{1,3}){3}(\/[0-9]{1,2}))$/", $_REQUEST['ipfirst']))
    {
